package com.proyecto.nodotrabajador3;
...
public class NodoTrabajador3Application implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(NodoTrabajador3Application.class, args);
    }
